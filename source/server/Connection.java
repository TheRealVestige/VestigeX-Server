...
public class Connection {
	...
	**/
	...
	/**
	* Reads all usernames from text file then adds them all to the mute list
	**/
	...
	**/
	...
	/**
	* Reads all the Ips from text file then adds them all to mute list
	**/
	...
	/**
	* Tells us if the IP had received it's first starter pack.
	**/
	...
	/**
	* Tells us if the IP had received it's second starter pack.
	**/
	...
	/**
	* Tells us the IP Has received the first starter package..
	**/
	...
	/**
	* Tells us the IP Has received the second starter package..
	**/
	...
	/**
	* Adds the Username To The Received First Starter List.
	**/
	...
	/**
	* Adds the Username To The Received Second Starter List.
	**/
	...
	/**
	* Adds the IP To The Received First Starter List.
	**/
	...
	/**
	* Adds the IP To The Received Second Starter List.
	**/
	...
	**/
	...
	/**
	* Writes the username into the text file - when using the ::mute playername command
	**/
	...
	**/
	...
	/**
	* Writes the IP into the text file - use ::ipmute username
	**/
	...
	/**
	* Checks to see if the user is muted upon connection.
	**/
