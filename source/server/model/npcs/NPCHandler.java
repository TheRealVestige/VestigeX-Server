		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] != null) {
				if (j == npcs[i].spawnedBy)
					return j;
				if (goodDistance(Server.playerHandler.players[j].absX, Server.playerHandler.players[j].absY, npcs[i].absX, npcs[i].absY, 2 + distanceRequired(i) + followDistance(i)) || isFightCaveNpc(i) || isDominionNpc(i) || isRFDNpc(i)) {
...
if (npcs[i].npcType == 6216) {
	c.customPoints += 15;
	c.pcPoints += 25;
	c.sendMessage("You recieve 15 Custom & 25 Vestige-x Points for killing the Pyrefiend.");
}		
if (npcs[i].npcType == 98) {
	c.customPoints += 10;
	c.pcPoints += 20;
	c.sendMessage("You recieve 10 Custom & 20 Vestige-x Points for killing the Spongebob.");
}
if (npcs[i].npcType == 97) {
	c.customPoints += 6;
	c.pcPoints += 15;
	c.sendMessage("You recieve 6 Custom & 15 Vestige-x Points for killing the Pikachu.");
...
if (npcs[i].npcType == 8349) {
	...
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the TD.");
}
if (npcs[i].npcType == 50) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the KBD.");
}
if (npcs[i].npcType == 1158) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the KQ.");
}
...
if (npcs[i].npcType == 4477) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Mad Mummy.");
}
if (npcs[i].npcType == 41) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Wrecker.");
}
if (npcs[i].npcType == 8133) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Corp.");
}
if (npcs[i].npcType == 2636) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Nex.");
}
if (npcs[i].npcType == 2586) {
	c.customPoints += 35;
	c.pcPoints += 50;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Protector.");
}
if (npcs[i].npcType == 5666) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Barrelchest.");
}
if (npcs[i].npcType == 3340) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Mole.");
}
if (npcs[i].npcType == 10530) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Forgotten Warrior.");
}
if (npcs[i].npcType == 10775) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the Frost Dragon.");
}
...
if (npcs[i].npcType == 40) {
	c.customPoints += 10;
	c.pcPoints += 10;
	c.sendMessage("You recieve 10 Custom & Vestige-x Points for killing the VB.");
}		
...
if (npcs[i].npcType == 96) {
c.customPoints += 3;
c.sendMessage("You recieve 3 custom points for completing the first round");
c.getPA().movePlayer(2862, 9951, 0);
AchievementManager.increase(c, Achievements.PKMK);
}
if (npcs[i].npcType == 95) {
c.customPoints += 4;
c.sendMessage("You recieve 4 custom points for completing the second round");
c.getPA().movePlayer(3017, 5199, 0);
AchievementManager.increase(c, Achievements.PKMK);
}
if (npcs[i].npcType == 94) {
c.customPoints += 5;
c.sendMessage("You recieve 5 custom points for completing the third round");
c.getPA().movePlayer(2909, 3616, 0);
AchievementManager.increase(c, Achievements.PKMK);
}
if (npcs[i].npcType == 93) {
c.customPoints += 6;
c.sendMessage("You recieve 6 custom points for completing the fourth round");
c.getPA().movePlayer(3364, 3312, 0);
AchievementManager.increase(c, Achievements.PKMK);
}
if (npcs[i].npcType == 92) {
c.customPoints += 7;
c.sendMessage("You recieve 7 custom points for completing the fifth round");
c.getPA().movePlayer(2701, 9838, 0);
AchievementManager.increase(c, Achievements.PKMK);
}
if (npcs[i].npcType == 99) {
c.customPoints += 8;
c.sendMessage("You recieve 8 custom points for completing the sixth round");
...
c.customPoints += 10;
c.sendMessage("You recieve 10 custom points for completing the mini-game");
		...
		if(c != null) {
			if (c.slayerTask == npcs[i].npcType ){
				...
				if (npcs[i].npcType == 1645 || npcs[i].npcType == 1591 || npcs[i].npcType == 1618 || npcs[i].npcType == 1643 || npcs[i].npcType == 941 || npcs[i].npcType == 119 || npcs[i].npcType == 82 || npcs[i].npcType == 52 || npcs[i].npcType == 1612 || npcs[i].npcType == 117 || npcs[i].npcType == 1265 || npcs[i].npcType == 112 || npcs[i].npcType == 125) {
					...
					c.sendMessage("You receive 10 Vestige-x Points.");
				}
				if (npcs[i].npcType == 1624 || npcs[i].npcType == 1610 || npcs[i].npcType == 1592 || npcs[i].npcType == 1613 || npcs[i].npcType == 1615 || npcs[i].npcType == 55 || npcs[i].npcType == 84 || npcs[i].npcType == 49 || npcs[i].npcType == 1618 || npcs[i].npcType == 941 || npcs[i].npcType == 82 || npcs[i].npcType == 2783 || npcs[i].npcType == 1341) {
					...
					c.sendMessage("You receive 15 Vestige-x Points.");
				}
				if (npcs[i].npcType == 1648 || npcs[i].npcType == 117 || npcs[i].npcType == 1265 || npcs[i].npcType == 90 || npcs[i].npcType == 103 || npcs[i].npcType == 78 || npcs[i].npcType == 119 || npcs[i].npcType == 18 || npcs[i].npcType == 101 || npcs[i].npcType == 1265 || npcs[i].npcType == 181) {
					...
					c.sendMessage("You receive 5 Vestige-x Points");
				}
				if (npcs[i].npcType == 3847 || npcs[i].npcType == 8596 || npcs[i].npcType == 3943 || npcs[i].npcType == 8528 || npcs[i].npcType == 53 || npcs[i].npcType == 9947 || npcs[i].npcType == 10775 || npcs[i].npcType == 9467 || npcs[i].npcType == 9465 || npcs[i].npcType == 6260 || npcs[i].npcType == 2881 || npcs[i].npcType == 2882 || npcs[i].npcType == 2883 || npcs[i].npcType == 8133 || npcs[i].npcType == 8349 || npcs[i].npcType == 40 || npcs[i].npcType == 9463) {
					...
					c.sendMessage("You receive 25 Vestige-x Points.");
				}
