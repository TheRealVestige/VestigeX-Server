...
/**
 * @author Sanity - REDONE BY GABBE ADDED TORVA N SHIT.
 */
...
if (c.OverloadCounter > 0) {
			c.sendMessage("You are already Overloaded!");
			return;
		}
		...
		handleOverloadTimers();
			...
			c.OverloadCounter = 300;
	}
	
	public void handleOverloadTimers() {
       Server.getTaskScheduler().addEvent(new Task(500, false) {
		public void execute() {
				if (c == null)
					this.stop();
