...
c.getPA().showInterface(58000);
		...
		case 226147:
			...
			//endthat
                //BOSS TELEPORTS
		case 164027:
		c.getPA().startTeleport(2271, 4681, 0, "modern");
		break;
		case 176167:
		case 178055:
		case 177211:
		...
		break;
		case 164033:
		c.getPA().startTeleport(3234, 9368, 0, "modern");
		break;
		case 164029:
		c.getPA().startTeleport(3293, 9374, 0, "modern");
		c.sendMessage("Warning: You may need a team.");
		break;
		case 178040:
		AchievementManager.increase(c, Achievements.VENTURE);
		c.getPA().startTeleport(3035, 3699, 0, "modern");
		case 178043:
		c.getPA().startTeleport(2993, 3599, 0, "modern");
		break;
		case 164031:
		c.getPA().startTeleport(3467, 9495, 0, "modern");
		break; 
		case 164023:
		c.getPA().startTeleport(2881, 5310, 2, "modern");
		break;
		case 164037:
		c.getPA().startTeleport(2368, 4956, 0, "modern");
		break;
		case 164041:
		c.getPA().startTeleport(1761, 5196, 0, "modern");
		break;
		case 164039:
		c.getPA().startTeleport(2517, 3044, 0, "modern");
		break;
		case 164035:
		c.getPA().startTeleport(2962, 9631, 0, "modern");
		break;
		case 164021:
		c.getPA().startTeleport(3055, 5185, 0, "modern");
		c.sendMessage("Wrecker is extremely dangerous.");
		break;
		case 164019:
		c.getPA().startTeleport(3037, 5234, 0, "modern");
		...
		break;
		case 71032://DONATE
		c.getPA().sendFrame126("www.vestigex.com/donate.html", 12000);
		c.sendMessage("Thank you for clicking, this keeps the server alive!");
		break;
		case 71029://VOTE
		c.getPA().sendFrame126("www.vestigex.com/vote.php", 12000);
		...
		break;
		case 126252:
			c.getPA().spellTeleport(2603, 3081, 0);
		break;
		case 126253:
			c.getPA().closeAllWindows();
		break;
		//endofinterface
		case 71026://WEBSITE
		c.getPA().sendFrame126("www.vestigex.com", 12000);
		break;
                case 65064:
		...
		case 132211:				c.getDH().sendOption2("Yak's (Neitznot)", "Rock Crabs");
		...
		break;
		case 72038:
		c.getDH().sendOption4("Protector", "Chaos Elemental", "Baws", "Baws");
		break;
		...
		case 108005:
			if (c.inTrade)
			{
				c.sendMessage("Bills Bustin Your Balls..");
				return;
			}
		...
		case 58073:
			...
			c.getPA().sendFrame126("www.vestigex.com/forums/forum.php",-1);
			c.sendMessage("Opened forums, Request A New Pin on Forums!");
		break;

                case 113236:
			c.getPA().sendFrame126("www.vestigex.com",-1);
		...
		case 17111://stop viewing viewing orb
			...
			case 108003:
				...
				c.getPA().showInterface(4200);
				        ...
				        c.sendMessage("You must be an donator to view the donator interface!");
                                }
			break;
...
if (c.dialogueAction == 58) {
	...
	break;
			...
			case 9157:
                        if (c.teleAction == 60) {
				c.getPA().spellTeleport(2956, 3218, 0);
		...
		if (c.dialogueAction == 10010) {
			if (c.getItems().playerHasItem(19931, 1) && c.getItems().playerHasItem(13347, 1) && c.getItems().playerHasItem(11144, 1) && c.getItems().playerHasItem(7783, 1)) {
			c.getItems().deleteItem(19931, 1);
			c.getItems().deleteItem(13347, 1);
			c.getItems().deleteItem(11144, 1);
			c.getItems().deleteItem(7783, 1);
		...
		//	c.sendMessage("Do not relog!");
			...
			if (c.dialogueAction == 1000) {
			c.getPA().spellTeleport(2097, 3162, 0);
			}
...
//END			
			...
			case 50245:
			case 117123:
			//c.getDH().sendOption5("Barb Assault", "Recipe for Disaster", "Nomad & Angry Goblin", "Castle Wars", "Dominion Tower");
			//c.teleAction = 199;
			...
			c.sendMessage("Taverly map data is currently not working, sorry");
