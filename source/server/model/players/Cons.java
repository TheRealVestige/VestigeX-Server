...
this.stop();
			...
			return;
					...
					public static void BuildTeleportFuckerrDerpHurrDurr(final Client c) {
							if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
if (c.playerLevel[23] > 67) {
			...
			return;
					...
					public static void BuildHurryDurryCrystalCuzGabbeIsBAAAWS(final Client c) {
							if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
if (c.playerLevel[23] > 67) {
			...
			return;
					...
					public static void BuildLecterFuckersss(final Client c) {
							if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
if (c.playerLevel[23] > 63) {
			...
			public static void SpawnDaMuneyNiggaChest(final Client c) {
					if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
this.stop();
			...
			public static void SpawnLectaNiggas(final Client c) {
					if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
this.stop();
		...
		public static void SpawnDaTree(final Client c) {
				if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
this.stop();
		...
		public static void SpawnDaBed(final Client c) {
				if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
this.stop();
		...
		public static void SpawnDaAltar(final Client c) {
				if(!c.isInPrivCon()) {
		c.sendMessage("You need to be in the construction skilling area first!");
		return;
		}
...
//CONSTRUCTION INTERFACES
			...
			case 122102://private
				...
				c.sendMessage("Currently Disabled, Please Use the public zone");
				//SpawnDaAltar(c);
				//SpawnDaTree(c);
				//SpawnDaMuneyNiggaChest(c);
				//SpawnDaBed(c);
				//SpawnLectaNiggas(c);
				//SpawnTeleporter(c);
			break;
