...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 397:
                sendNpcChat1("Welcome to the bank!", c.talkingNpc, "Banker");
                c.nextChat = 398;
                break;
                case 398:
		sendPlayerChat1("Thank you sir.");
		c.nextChat = 0;
		break;
                case 179:
		sendNpcChat2("Greetings " + c.playerName +"", "Intrested in driving my car?", c.talkingNpc, "Racing Monk");
		c.nextChat = 180;	
	        break;
	        case 180:
		sendOption2("Yes please! I would love to drive!", "No thanks I'm good for now.");
		c.dialogueAction = 180;
		c.nextChat = -1;
	        break;
                case 7777:
                ...
                break;
                case 9995:
                sendOption4("Enter Dominion Tower.", "DT Exchange.", "Is Dominion Tower safe?", "Nevermind.");
                c.dialogueAction = 9995;
                break;
                case 185:
		sendNpcChat4("Hello, im Lottie im in charge of "+Config.SERVER_NAME+"'s Lottery.", "Entering costs 10 million gp but you could win up to", "250 million gp! you can enter up to 5 times per draw.", "Would you like to enter the lottery?", c.talkingNpc, "Lottie");
		c.nextChat = 186;
		break;
		case 186:
		...
		break;
                case 4433:
		c.getDH().sendNpcChat4("Hey, Im King Milestone", "I sell Milestone capes.", "If You Right Click Me", "And Click Milestone", c.talkingNpc, "King Milestone");
		c.nextChat = 4434;
		break;
                case 4434:
		c.getDH().sendNpcChat4("Then You Have Acess to Milestone", "Once You're Level 10+ in All stats", "This Ingame Feature Will Be Available", "Thanks, Bye!", c.talkingNpc, "King Milestone");
		c.nextChat = 0;
		break;
                case 4439:
		c.getDH().sendNpcChat4("Hey, care to play pest control?", "Pest Control is a fun minigame.", "If you would like to play", "then you should", c.talkingNpc, "Pest Control Server Manager");
		c.nextChat = 4438;
		break;
                case 4438:
		c.getDH().sendNpcChat4("Click the gangplank next to me", "Once You're at the island", "Follow the path and jump in boat with ", "Three friends", c.talkingNpc, "Pest Control Server Manager");
		c.nextChat = 0;
		break;
case 400:
sendOption4("Floor 1 - Level 1","Floor 2 - Level 50","Floor 3 - Level 99","Dungeoneering Shop");
c.dialogueAction = 90;
c.teleAction = -1;
break;

case 33:
			sendNpcChat3("You clean off the dust off of the Ancient effigy.", "The relic begins to make some sort of weird noises.", "I think there may be something inside here.", c.talkingNpc, "Ancient Effigy");
			c.nextChat = 34;
			break;
		case 34:
			if(c.getLastClicked() == 18778) {
				sendNpcChat3("This will require at least a level of 91 in one of the two skills", "to investigate. After investigation it becomes nourished,", "rewarding 15,000 experience in the skill used.", c.talkingNpc, "Starved ancient effigy");
			} else if (c.getLastClicked() == 18779) {
				sendNpcChat3("This will require at least a level of 93 in one of the two skills", "to investigate. After investigation it becomes sated,", "rewarding 30,000 experience in the skill used.", c.talkingNpc, "Nourished ancient effigy");
			} else if (c.getLastClicked() == 18780) {
				sendNpcChat3("This will require at least a level of 95 in one of the two skills", "to investigate. After investigation it becomes gordged,", "rewarding 45,000 experience in the skill used.", c.talkingNpc, "Sated ancient effigy");
			} else if (c.getLastClicked() == 18781) {
				sendNpcChat4("This will require at least a level of 97 in one of the two skills", "to investigate. After investigation it provides 60,000 ", "experience in the skill used and, then crumbles to dust,", "leaving behind a dragonkin lamp.", c.talkingNpc, "Gorged ancient effigy");
			}
			if(c.effigy == 0) {
				c.nextChat = 35;
			} else {
...
break;
		//new jad
						case 3332:
		c.getDH().sendNpcChat2("Hello, you're not skilled enough to talk to me.", "You need atleast level 30 Def and 50 Prayer.", c.talkingNpc, "Brother Kojo");
		c.nextChat = 3334;
		break;
				case 3333:
		c.getDH().sendNpcChat4("Hello, i see that you're over", "30 Defence and 50 Prayer.", "Would you want me to take you to the", "Chaos altar where you can unleash the power of Zaros?", c.talkingNpc, "Brother Kojo");
		c.nextChat = 3334;
		break;
						case 3334:
		...
		break;
			 	 ...
			 	 case 29165:
			c.getDH().sendPlayerChat2("HOW MUCH?!", "Have You got Anything else for say.. 25m");
			c.nextChat = 29166;
		break;
	 ...
	 case 28164:
		...
		break;
		case 5555:
		sendNpcChat4("WARNING:", "Nex Is Extrememly Hard to Defeate", "It requires ATLEAST 5 Players", "Range is recommended.", c.talkingNpc, "WARNING");
		c.nextChat = 5556;
		break;
				case 5556:
		...
		break;
								...
								case 1139:
		sendNpcChat4("Would you atleast let me finish?", "I was going to tell you that i've retired.","Well I'm going to tell you a little about FireMaking.", "All you need to do is use a tinderbox on a log.", c.talkingNpc, "FireMaker");
			c.nextChat = 1140;
		break;
...
sendNpcChat3("Welcome my friend!", "Here you can train Woodcutting", "Buy your axe from me and get started!", c.talkingNpc, "Woodcutter");
	...
	break;
		case 1552:
		sendNpcChat3("Ho, ho ho!","Can You Help Me?", "I Need you to collect presents for me", c.talkingNpc, "Santa");
		c.nextChat = 1553;
	break;
		case 1553:
		sendNpcChat3("There is a Mysterious Ghost","In Every City on the Lodestones", "Take this snow globe to help!", c.talkingNpc, "Santa");
                                           c.getItems().addItem(11949, 1);
		c.santaPrize = 1;
		c.nextChat = 1554;
	break;
		case 1554:
		sendPlayerChat1("Sure Santa, ill use this snowglobe to locate them!");
		c.nextChat = 0;
	break;
		...
		break;
						...
						case 258:
			sendNpcChat2("Are you sure you wish to drop this item?", "It will Dissapear, and you can't get it back!", c.talkingNpc, ""+Config.SERVER_NAME+" Protection System");
			c.nextChat = 259;
			break;
			case 259:
		...
		case 2001:
			...
			break;
					...
					case 2008:
			sendPlayerChat1("Yeh sure..But you better own that Bill guy!");
			//c.hBQ = 1;
			c.nextChat = 2009;
		break;
		...
		break;
					case 2016:
			sendNpcChat2("Correct. Bring the me the enchanced items when you're done", "And i'll reward you.", c.talkingNpc, "Kaqemeex");
			c.nextChat = 0;
			c.bMQ = 2;
			break;
			...
			case 2018:
			sendNpcChat4("Herblore is a very powerful skill,", "When you're Herblore level is around 82,", "You will be able to make Powerful Potions", "Like Extreme Pots, they raise your stats ALOT!", c.talkingNpc, "Kaqemeex");
			c.nextChat = 2019;
			break;
...
break;
		...
		break;
						case 209:
			sendNpcChat4("Hello there "+c.playerName+"!","If you're level 80+ herblore you can buy","Herbs from me and mix your own","Extreme pots! Or at 96 overloads!", c.talkingNpc, "Potion mixer");
			c.nextChat = 0;
		break;
		...
		break;
				case 3789: // 1283
                     	sendNpcChat2("Hello! I sell stuff for "+Config.SERVER_NAME+" Points.", "You have " + c.pcPoints + " "+Config.SERVER_NAME+" Points Atm!",c.talkingNpc, ""+Config.SERVER_NAME+" Points Shop!");
						c.nextChat = 0;
		break;
						case 211: // 1283
		...
		case 80:
                ...
                case 37:
                        sendStatement("You need at least 1 free inventory space and a crystal key!");
                        c.nextChat = 0;
                break;		
	...
	case 76:
		...
		break;
			...
			"So Would You like to Fight?", c.talkingNpc, "Nomad");
			c.nextChat = 8592;
		break;
		case 8592:
		...
		break;
			...
			"i will bring you there.", c.talkingNpc, "Traveller");
			c.nextChat = 71;
		break;
		case 1000:
		sendNpcChat4("Hello, My name is Mr Krabbs", "I am a master of the custom NPC's.", "I can take you to fight custom NPC's for points.", 
			"Would you like me to take you there?", c.talkingNpc, "Mr. Krabbs");
			c.nextChat = 1001;
		break;
		case 1001:
		sendOption2("Yes, that sounds great.", "Not right now, Krabbs.");
			c.dialogueAction = 1000;
		break;
		case 1002:
		sendNpcChat4("Hello, My name is Sigli", "I am a master of Hunter, Bill has asked me", "To direct players to hunter.", 
			"Would you like me to take you there?", c.talkingNpc, "Sigli The Huntsman");
			c.nextChat = 1003;
		break;
		case 1003:
		sendOption2("Lets go, Sigli.", "Not right now, maybe some other time.");
		c.dialogueAction = 1001;
		break;
		case 1004:
		sendNpcChat4("Hello, I sell custom items", "For the custom points you recieve.", "Item's aren't cheap, but are worth the time spent.", 
			"Would you like to see what you can buy?", c.talkingNpc, "Homer");
			c.nextChat = 1005;
		break;
		case 1005:
		sendOption2("Yes, that sounds great.", "Not right now.");
			c.dialogueAction = 1003;
		break;
		case 1006:
		sendNpcChat4("Hello, I'm In charge of the Achievements.", "Right Click Me For Your Options.", "Titles Will Change When You Teleport Or Relog.", 
			"Achievement Points Shop Is Coming.", c.talkingNpc, "Achievement Manager");
		break;
		case 1007:
		sendNpcChat4("Hello, I sell Chaotic Whips, The Most Powerful", "Weapon in Vestige-x. It costs:", "A Brutal Whip, C Claws, A Pink Whip, an Aqua Whip.", 
			"And 500m. Would you like to buy one?", c.talkingNpc, "Oracle");
			c.nextChat = 1008;
		break;
		case 1008:
		sendOption2("Yes, that sounds great.", "Not right now.");
