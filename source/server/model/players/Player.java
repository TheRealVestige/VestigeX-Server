...
public abstract class Player {
	...
	public boolean usedxplock = false;
	...
	public boolean playerFletch, playerIsFletching, fletchLevelReq, playerIsMining, playerIsFiremaking, playerIsFishing, playerIsCooking, playerIsWoodcutting;
    public boolean usingAltar = false;
    public int altarItemId = 0;
    public int PresentsDone = 0;
    public int present = 0;
    public boolean hasFinishedEvent = false;
    public boolean present1 = false;
    public boolean present2 = false;
    public boolean present3 = false;
    public boolean present4 = false;
    public boolean present5 = false;
    ...
    public int dominionToKill = 0;
    public int dominionKilled = 0;
    public int DTPoints = 0;
	public int AuraEquiped = -1;
    public int AuraEffect = 0;
    public int AuraTime = 0;
    ...
    public String voteDelay = "0";
    public String voteLength = "0";
    public String tbTime = "0";
	...
	public int gwdelay;
	public int conaltar;
	public int vlsLeft;public int vlsLeft2;
	...
	{18357,15241,9185,839,845,847,
	851,855,859,841,843,849,853,857,
	861,4212,4214,4215,11235,4216,
	4217,4218,4219,4220,4221,4222,
	4223,6724,4734,4934,4935,4936,
	4937};

	public int BlackMarks = 0;
	
	public final int[] ARROWS = 
	{15243, 882,884,886,888,890,
	892,4740,11212,9140,9141,4142,
	9143,9144,9240,9241,9242,9243,
	9244,9245};

	public final int[] NO_ARROW_DROP = 
	{15243, 4212,4214,4215,4216,4217,
	4218,4219,4220,4221,4222,4223,4734,
	4934,4935,4936,4937};

	public static final int[] Bolts	=	
	{877, 4740, 9139, 9140, 9141, 9142, 
	9143, 9144, 9145, 9236, 9237, 9238, 
	9239, 9240, 9241, 9242, 9243, 9244, 
	9245};

	public final int[] OTHER_RANGE_WEAPONS = 	
	{863,864,865,866,867,868,869,806,807,808,
		809,810,811,825,826,827,828,829,830,
		800,801,802,803,804,805,6522,13879,
		15016};
	...
	public int[] autocastIds = {51133,32,51185,33,51091,34,24018,35,51159,36,51211,
								37,51111,38,51069,39,51146,40,51198,41,51102,42,51058,
								43,51172,44,51224,45,51122,46,51080,47,7038,0,7039,1,
								7040,2,7041,3,7042,4,7043,5,7044,6,7045,7,7046,8,7047,
								9,7048,10,7049,11,7050,12,7051,13,7052,14,7053,15,47019,
								27,47020,25,47021,12,47022,13,47023,14,47024,15};
	...
	public final int[] DUEL_RULE_ID = {1, 2, 16, 32, 64, 128, 256, 512, 
    ...
    public boolean inDT() {
            return absX >= 3158 && absX <= 3181 && absY >= 9752 && absY <= 9764;
    }

    public boolean inDrive() {
            return absX >= 2963 && absX <= 2991 && absY >= 3226 && absY <= 3253;
    }
	...
	public boolean inWild() {
    	Client c = (Client) Server.playerHandler.players[this.playerId];
			...
			if(absX > 2941 && absX < 3392 && absY > 3526 && absY < 3968 ||
	...
	public boolean InDung() {
		if(absX > 3042 && absX < 3042 && absY > 5231 && absY < 5234) {	
    return true;
		}
	return false;	
	}
	...
	if(absX > 2049 && absX < 2098 && absY > 3131 && absY < 3266 && heightLevel > 2) {	
		return true;
	}
	return false;
	}
	...
	public boolean hasGrapple() {
		Client c = (Client) Server.playerHandler.players[this.playerId];
			if (c.playerEquipment[c.playerArrows] == 9419) {
		return true;
			}
		return false;
	}
	...
	(absX >= 3460 && absX <= 3505 && absY >= 9480 && absY <= 9520) ||
			...
			(absX >= 3159 && absX <= 3179 && absY >= 9756 && absY <= 9762) ||
			(absX >= 2845 && absX <= 2856 && absY >= 3477 && absY <= 3503) ||
...
public int CIcon = 0; 
	...
	public int hitIcon, hitFocus, hitMax;
